...
sed -i '1s/^/from django.test.testcases import skipIfDBFeature\n/' /home/travis/virtualenv/python2.7/lib/python2.7/site-packages/django/contrib/sites/tests.py
...
sed -i '1s/^/from django.test.testcases import skipIfDBFeature\n/' /home/travis/virtualenv/python2.7/lib/python2.7/site-packages/django/contrib/auth/tests/context_processors.py
...
sed -i '1s/^/from django.test.testcases import skipIfDBFeature\n/' /home/travis/virtualenv/python2.7/lib/python2.7/site-packages/django/contrib/auth/tests/remote_user.py
...
sed -i '1s/^/from django.test.testcases import skipIfDBFeature\n/' /home/travis/virtualenv/python2.7/lib/python2.7/site-packages/django/contrib/auth/tests/tokens.py
